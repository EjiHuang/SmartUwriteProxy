...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private CloseForm configForm; //CloseForm(controller);
        ...
        {
            MessageBox.Show(e.GetException().ToString(), String.Format(I18N.GetString("Proxy Error: {0}"), e.GetException().Message));
        }
        ...
        private void ShowConfigForm()
        {
            ...
            {
                configForm = new CloseForm(controller);
                configForm.Show();
                //configForm.FormClosed += configForm_FormClosed;
            }
            //CloseForm cform = new CloseForm(controller);
            //cform.ShowDialog();
        ...
        private void ShowFirstTimeBalloon()
        {
            if (_isFirstRun)
            {
                _notifyIcon.BalloonTipTitle = I18N.GetString("BimtShadowsocks is here");
                _notifyIcon.BalloonTipText =  I18N.GetString("You can turn on/off BimtShadowsocks in the context menu");
